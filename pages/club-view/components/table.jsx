...
export default function table(props) {
  ...
  { 
    ...
    temp.push({name:name, role:role, year:year, program:program, id:id})
  ...
  function quick()
  {
    ...
    let picType = "headshot"
    let picID = "640e44bbb7d709ee7ffb3a9a"

    const getObjects = gql`query Query($objType: String, $objId: String) {
      getObjects(objType: $objType, objId: $objId) {
        filename
        objId
        objType
        url
    ...
    .then((data) => {
      temp[0].avatar = data.data.getObjects[0].url
      setTeam([...temp])
  ...
  return (
    ...
    <Modal
      ...
      <Button onPress={()=>{quick()}}>PRess me</Button>
